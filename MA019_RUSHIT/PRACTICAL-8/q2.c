...
void addEdge(int src, int dest) {
        ...
        newNode->vertex = dest; newNode->next = adjList[src]; adjList[src] = newNode;
...
void bfsList(int startVertex) { 
                ...
                if (!visited[adjVertex]) {
                visited[adjVertex] = 1; queue[++rear] = adjVertex;
                }
...
int main() { 
    createGraph();
        ...
        int visited[max_vert] = {0}; dfsMatrix(1, visited); printf("\n");
